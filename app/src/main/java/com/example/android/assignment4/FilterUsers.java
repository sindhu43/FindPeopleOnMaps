...
public class FilterUsers extends AppCompatActivity  {
    ...
    String countries,states,country_selected,state_selected,year_selected,params,parameter,usersResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterMapBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DownloadWebpageTask finalUser=new DownloadWebpageTask();
                try {
                    usersResult=finalUser.execute("http://bismarck.sdsu.edu/hometown/users?page=0&"+parameter).get();
                    Log.d("message","from filterUser.java: "+usersResult);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                } catch (ExecutionException e) {
                    e.printStackTrace();
                ...
                bundleuser.putString("userarray",usersResult);
                newintent.putExtras(bundleuser);
                //getSupportFragmentManager().beginTransaction().add(R.id.mapHolder, mapView).commit();
